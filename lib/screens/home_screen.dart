          ...
          if(snapShoot.connectionState == ConnectionState.waiting){
            ...
            return Consumer<UserProvider>(
                builder: (context,data,child){
                 final totalMember= data.members.length;
                  return  Scaffold(
                    appBar: AppBar(
                      title: AppBar(
                       ...
                       Consumer<NoteProvider>(
                           builder: (context,note,child){
                             final monthlyReport=note.getTotalMonth();
                             return  Text('${monthlyReport} B',style: TextStyle(fontWeight: FontWeight.bold),);
                           }
                       )
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Consumer<NoteProvider>(
                                          builder: (context,note,child){
                                            final currentMonthlyReport=note.getCurrentMonthTotal();
                                            return  Text('B ${currentMonthlyReport} ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),);
                                          }
                                      )
                                    ],
                                  ),
